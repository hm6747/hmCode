...
<script src="${pageContext.request.contextPath}/js/common/common_base.js"></script>
<script src="${pageContext.request.contextPath}/js/common/common-validate.js"></script>
<script src="${pageContext.request.contextPath}/js/bootstrap.min.js?v=3.3.6"></script>
<script src="${pageContext.request.contextPath}/js/zxf_page.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/plugins/ztree/jquery.ztree.all.min.js"></script>
