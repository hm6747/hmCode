...
<!--ztree-->
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/js/plugins/ztree/zTreeStyle.css" type="text/css">
<script type="text/javascript" src="${pageContext.request.contextPath}/static/js/plugins/ztree/jquery.ztree.all.min.js"></script>
<!--分页-->
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/zxf_page.css">
<script src="${pageContext.request.contextPath}/static/js/zxf_page.js"></script>
<!--富文本-->
...
<!--自定义-->
<script src="${pageContext.request.contextPath}/static/js/common/common_base.js"></script>
<script src="${pageContext.request.contextPath}/static/js/common/common-validate.js"></script>